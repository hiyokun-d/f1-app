...
function StartingLights({ phase, litCount }: { phase: string; litCount: number }) {
  return (
            ...
            >
              {isLit && !isGone && (
                <div
                  ...
                  style={{
                    background: 'radial-gradient(circle at 35% 35%, rgba(255,120,120,0.6), transparent 70%)',
                  }}
                />
              )}
            </div>
...
export default function Home() {
  ...
  const [lightsPhase, setLightsPhase] = useState<'off' | 'lighting' | 'go'>('off')
  ...
  useEffect(() => {
    ...
    return () => { clearTimeout(t1); clearTimeout(t2); clearTimeout(t3); clearTimeout(lightTimer) }
  }, [])
            ...
            {TITLE_LETTERS.map((letter, i) => (
              <span
                ...
                style={{
                  ...
                  color: letter === ' ' ? 'transparent' : i < 4 ? '#ffffff' : 'var(--f1-red)',
          ...
          >
            ...
            {hovered && (
              <div
                ...
                style={{
                  background: 'linear-gradient(180deg, transparent, rgba(232,0,45,0.04), transparent)',
