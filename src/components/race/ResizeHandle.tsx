...
export default function ResizeHandle({
  side, currentWidth, onResize, minWidth = 180, maxWidth = 600,
}: Props) {
  ...
  return (
    <div
      ...
      style={{ ...edgeStyle, width: 8 }}
    >
      {/* Thin red line — appears on hover */}
      <div
        className="w-px transition-all duration-150 opacity-0 group-hover:opacity-100"
        style={{
          height: 48,
          background: 'rgba(232,0,45,0.7)',
          boxShadow: '0 0 6px rgba(232,0,45,0.4)',
        }}
      />
    </div>
  )
